...
namespace DelegationStation.API
{
    ...
    public class BulkDeviceController : Controller
    {
        ...
        public async Task<IActionResult> Download(string id = "")
        {
            ...
            sb.AppendLine("Make,Model,SerialNumber,OS,PreferredHostname,Action,AddedBy,State");
            ...
            if (!string.IsNullOrEmpty(sanitizedID))
            {
                ...
                foreach (Device device in devices)
                {
                    ...
                    sb.AppendLine($"{device.Make},{device.Model},{device.SerialNumber},{deviceOSstring},{device.PreferredHostname},,{device.AddedBy}, {device.Status.ToString()}");
                }
            }
