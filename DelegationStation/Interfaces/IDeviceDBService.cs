...
namespace DelegationStation.Interfaces
{
    public interface IDeviceDBService
    {
        ...
        Task<List<Device>> GetDevicesSearchAsync(IEnumerable<string> groupIds, string make, string model, string serialNumber, int? osID, string preferredHostname);
        Task<List<Device>> GetDevicesAsync(IEnumerable<string> groupIds, int pageSize = 10, int page = 0);
